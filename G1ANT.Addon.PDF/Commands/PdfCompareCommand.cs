...
namespace G1ANT.Addon.Pdf
{
    ...
    public class PdfCompareCommand : Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "Path to the first pdf")]
            public TextStructure Path1 { get; set; }

            [Argument(Required = true, Tooltip ="Path to the second pdf")]
            public TextStructure Path2 { get; set; }

            [Argument(Required = false, Tooltip = "Password to the file/files")]
            public TextStructure Password { get; set; }

            [Argument(Required = false, Tooltip = "Returns true if docuemnts are equal")]
